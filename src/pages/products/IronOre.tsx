...
const IronOre = () => {
  const productData = {
    name: "Iron Ore",
    subtitle: "High-Grade Iron Ore Concentrate for Global Industries",
    description:
      "Premium quality iron ore sourced from Nigeria's rich mineral deposits. Our zinc concentrates meet international standards for galvanizing, die-casting, and alloy production applications.",
    purity: "35-65%",
    grade: "Premium",
    applications: [
      "Galvanizing Steel",
