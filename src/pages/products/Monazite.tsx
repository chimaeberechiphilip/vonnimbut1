...
const Monazite = () => {
  const productData = {
    name: "Monazite",
    subtitle: "High-Grade Monazite Concentrate for Global Industries",
    description:
      "Premium quality Monazite sourced from Nigeria's rich mineral deposits. Our Monazite concentrates meet international standards for galvanizing, die-casting, and alloy production applications.",
    purity: "35-65%",
    grade: "Premium",
    applications: [
      "Galvanizing Steel",
    ...
    advantages: [
      "Consistent high-grade Monazite content meeting international standards",
