...
const Illuminate = () => {
  const productData = {
    name: "Zinc Ore",
    subtitle: "High-Grade Illuminate Concentrate for Global Industries",
    description:
      "Premium quality Illuminate sourced from Nigeria's rich mineral deposits. Our zinc concentrates meet international standards for galvanizing, die-casting, and alloy production applications.",
    purity: "35-65%",
    grade: "Premium",
    applications: [
      "Galvanizing Steel",
