...
const LeadOre = () => {
  const productData = {
    name: "Lead Ore",
    subtitle: "High-Grade Lead Concentrate for Global Industries",
    description:
      "Premium quality Lead ore sourced from Nigeria's rich mineral deposits. Our Lead concentrates meet international standards for galvanizing, die-casting, and alloy production applications.",
    purity: "35-65%",
    grade: "Premium",
    applications: [
      "Galvanizing Steel",
