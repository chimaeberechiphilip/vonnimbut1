...
const ZincOre = () => {
  const productData = {
    name: "Lithium",
    subtitle: "High-Grade Lithium Concentrate for Global Industries",
    description:
      "Premium quality Lithium sourced from Nigeria's rich mineral deposits. Our zinc concentrates meet international standards for galvanizing, die-casting, and alloy production applications.",
    purity: "35-65%",
    grade: "Premium",
    applications: [
      "Galvanizing Steel",
    ...
    advantages: [
      "Consistent high-grade Lithium content meeting international standards",
